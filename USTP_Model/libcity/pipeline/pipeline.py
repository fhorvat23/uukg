...
def run_model(task=None, model_name=None, dataset_name=None, config_file=None,
    ...
    # Transform the data and partition the dataset
    ...
    # Evaluation, the evaluation results will be placed under cache/evaluate_cache
    executor.evaluate(test_data)


def parse_search_space(space_file):
    if tune is None:
        raise ModuleNotFoundError('ray is required for hyperparameter search. Install ray[tune].')
    search_space = {}
