...
class DCRNN(AbstractTrafficStateModel, Seq2SeqAttrs):
    ...
    def encoder(self, inputs):
        ...
        for t in range(self.input_window):
            ...
            # encoder_hidden_state: all hidden layers of the encoder's multi-layer GRU (num_layers, batch_size, self.hidden_state_size)

        return encoder_hidden_state  # last hidden state
