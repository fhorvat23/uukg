...
class STAGGCN(AbstractTrafficStateModel):
    def __init__(self, config, data_feature):
        ...
        # The following two items are edge relationship data obtained by STAG-GCN's additional preprocessing of the data set.
        # The spatial adjacency edge set obtained by preprocessing the data set
        self.edge_index = self.data_feature.get('edge_index', torch.tensor([[], []], dtype=torch.long))  # spatial adjacency
        # Semantic adjacency edge set obtained by preprocessing the data set
        self.dtw_edge_index = self.data_feature.get('dtw_edge_index', torch.tensor([[], []], dtype=torch.long))  # semantic adjacency edge
