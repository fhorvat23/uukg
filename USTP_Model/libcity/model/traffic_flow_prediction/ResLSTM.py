...
"""Two-dimensional inflow and outflow inputs."""
...
def calculate_normalized_laplacian(adj):
    ...
    D_hat_sqrtm_inv = np.linalg.inv(D_hat_sqrt)  # get the D_hat**-1/2 (after taking the square root and inverting it, it is the -1/2 power of the matrix)
