...
class HGCNDataset(TrafficStatePointDataset):
    ...
    def __init__(self, config):
        ...
        # Number of cluster centers (regions)
        self.cluster_nodes = self.config.get('cluster_nodes', 40)
        # Region adjacency matrix initialization
        self.adj_mx_cluster = None
        # Center vector matrix of clustering, region [node]
    ...
    def get_cluster(self):
        ''':return: Center vector matrix after clustering, area [node]'''
    ...
    def calculate_adj_mx_cluster(self):
        ''':return: #Clustering result[cluster_num][] Clustering ID[cluster_num][]'''
